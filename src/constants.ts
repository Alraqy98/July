...
export const CONTENT = {
  ...
  kpis: {
    ...
    caution:
      "نقطة الانتباه الوحيدة: متوسط الفاتورة انخفض من 442 إلى 419 ليرة، وأصناف الفاتورة من 2.65 إلى 2.43 — النمو جاء من عمليات أكثر، لا من سلال أكبر.",
  },
  ...
  days: {
    ...
    takeaway:
      "الاثنين والثلاثاء قفزا نحو +69% — بينما تراجع السبت (-17.1%) ليصبح أكبر نقطة ضعف تحتاج معالجة.",
  },
  ...
  singles: {
    ...
    takeaway:
      "عملاء كثيرون يغادرون بصنف واحد فقط — الفرصة: تدريب الفريق على البيع الإضافي، بدءًا بمشتري الماء والشاي.",
  },
  ...
  decliners: {
    ...
    readings: [
      {
        title: "قراءتنا",
        desc: "معظم التراجع إحلال صحي: منتجات أقوى حلّت مكان أصناف أضعف.",
        positive: true,
      },
      {
        title: "خطوتنا",
        desc: "مراجعة كل صنف متراجع واتخاذ قرار واضح: تطوير أو استبدال أو إيقاف.",
        positive: false,
      },
    ],
  },
  ...
  conclusion: {
    ...
    achieved:
      "الإيراد ارتفع، الخصومات انخفضت، مبيعات الفترة المسائية قفزت، القهوة المختصة والمشروبات الباردة أصبحت محركات رئيسية، والأصناف الجديدة أضافت مبيعات ملموسة.",
    next:
