...
export const CONTENT = {
  ...
  kpis: {
    title: "الأداء العام",
    subtitle: "شهر أكبر وأنظف: إيراد أعلى مع خصومات أقل",
    cards: [
  ...
  decliners: {
    ...
    subtitle: "تستحق مراجعة واعية، لا انسحابًا صامتًا",
    items: [
  ...
  conclusion: {
    ...
    next:
      "الطبقة التالية: تحويل الحركة الأقوى إلى سلال أقوى، وجعل نهاية الأسبوع تؤدي كبقية أيامه.",
  },
