...
export const CONTENT = {
  ...
  kpis: {
    ...
    caution:
      "نقطة الانتباه الوحيدة: الخصومات نمت أسرع من الإيراد بوضوح وارتفعت حصتها من نحو 10% إلى 13% من المبيعات — تحتاج تفكيكًا وضبطًا خلال أغسطس.",
  },
  ...
  offer: {
    title: "عرض 299 كرواسون",
    subtitle: "نموّ متواصل كحركة — لكن أثره على السلة تغيّر",
    compare: [
      { period: "يونيو — Offer 299 Croissant", revenue: "42,900 TL", details: ["111 فاتورة", "143 قطعة"], delta: null },
      { period: "يوليو — Offer 299 Croissant", revenue: "55,140 TL", details: [], delta: "+29%" },
    ],
    tickets: {
      offer: { label: "متوسط فاتورة تتضمن العرض", value: "~410 TL" },
      normal: { label: "متوسط الفاتورة العادية", value: "~437 TL" },
    },
    takeaway:
      "العرض واصل النمو (+29%) لكن على عكس يونيو، فواتيره لم تعد أعلى من العادية — يعمل الآن كحركة متكررة أكثر منه بانيًا للسلة، ويحتاج ربطه ببيع إضافي (مشروب أو حلى) ليستعيد دوره.",
  },

  singles: {
    title: "فواتير الصنف الواحد",
    subtitle: "ما تزال أكبر فرصة تحسين (بدون فواتير عرض 299)",
    stats: [
  ...
  actions: {
    ...
    items: [
      ...
      {
        title: "إعادة عرض 299 لبناء السلة",
        desc: "ربط العرض ببيع إضافي ليعود رافعًا للفاتورة كما كان في يونيو.",
      },
      {
